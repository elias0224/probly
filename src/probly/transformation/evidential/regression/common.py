...
evidential_regression_traverser = lazydispatch_traverser[object](
    name="evidential_regression_traverser"
)
...
def register(cls: LazyType, traverser: RegisteredLooseTraverser) -> None:
    ...
    evidential_regression_traverser.register(
...
def evidential_regression[T: Predictor](base: T) -> T:
    ...
    return traverse(
        base,
        nn_compose(evidential_regression_traverser),
