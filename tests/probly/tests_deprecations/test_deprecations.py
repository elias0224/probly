...
from .utils import DEPRECATED_FEATURES, DeprecatedFeature
...
def feature_should_be_removed(feature: DeprecatedFeature) -> None:
    ...
    if parse(version("probly")) >= parse(feature.removed_in):
        pytest.fail(
...
def feature_raises_deprecation_warning(
    ...
    expected_msg = f"deprecated in version {feature.deprecated_in} and will be removed in version {feature.removed_in}."
